        ...
        >
            <div className="grid lg:grid-cols-2 gap-12">
                ...
                <div>
                    ...
                    {/* Social Links */}
                    <div>
                        <p className="text-sm font-medium text-zinc-700 mb-3">Connect with me</p>
                        <div className="flex gap-4">
                            {/* LinkedIn */}
                            <a
                                href="https://www.linkedin.com/in/venkateshspandan/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center w-10 h-10 rounded-lg border border-zinc-200 bg-white hover:bg-zinc-50 transition-colors"
                                aria-label="LinkedIn"
                            >
                            ...
                            {/* GitHub */}
                            <a
                                href="https://github.com/maxchalk"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center w-10 h-10 rounded-lg border border-zinc-200 bg-white hover:bg-zinc-50 transition-colors"
                                aria-label="GitHub"
                            ...
                            {/* Instagram */}
                            <a
                                href="https://www.instagram.com/spandan__kumar/"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center w-10 h-10 rounded-lg border border-zinc-200 bg-white hover:bg-zinc-50 transition-colors"
                            ...
                            {/* X (Twitter) */}
                            <a
                                href="https://x.com/spandankumar476"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center justify-center w-10 h-10 rounded-lg border border-zinc-200 bg-white hover:bg-zinc-50 transition-colors"
